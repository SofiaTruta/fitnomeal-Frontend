    ...
    <>
      ...
      {dailyWorkout !== null ? (
        dailyWorkout !== 'no workout' ? (
          <>
              <div className="bg-light-purple flex flex-col space-y-4 justify-center items-center p-4">
                  ...
                  <div key={index}>
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <div className="p-5">
                        ...
                        {showInstructions ? (
                         <div className="mb-4">
                         <p className="mb-3 font-bold text-gray-700 dark:text-gray-400">Instructions:</p>
                         <ol>
                         {workout.instructions.map((element, index) => (
              ...
              <div className="bg-light-purple flex flex-row justify-center">
                <Link
                  href="/"
                  onClick={handleComplete}
                  className="bg-gradient-to-r from-violet-500 to-fuchsia-500 focus:outline-none text-white hover:bg-gradient-to-r hover:from-sky-500 hover:to-indigo-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-lg px-8 py-3 mb-4 mr-4 dark:focus:ring-yellow-900 px-20 py-3"
                >
                  Finished it!
                </Link>
              </div>
